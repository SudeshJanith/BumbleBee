...
const CustomerDashboard = () => {
    ...
    useEffect(() => {
        AxiosClient.get("customer/products").then(res => {
            setCustomerProducts(res.data.products)
                                            ...
                                            customerProducts.map(product => (
                                                <div class="col-3">
                                                    <div class="card mb-3">
                                                        <div class="row g-0">
                                                            <div class="col-md-4">
                                                                {/* <img class="card-img card-img-left" style={{ height: '100%' }} src="../assets/img/elements/12.jpg" alt="Card image" /> */}
                                                                {product.image ? ( <img src={`http://127.0.0.1:8000/storage/products/${product.image}`} style={{ height: '100%', width:'70px' }} alt="Avatar" class="rounded-circle" /> ) : (
                                                                    <img src="http://127.0.0.1:8000/img/default-image.jpg" style={{ height: '100%', width:'70px' }} alt="Avatar" class="rounded-circle" />
                                                                )}
                                                            </div>
                                                            <div class="col-md-8">
                                                                <div class="card-body">
