...
const ProductUpdate = () => {
    ...
    const [available_quantity, setAvailableQTY] = useState("");
    ...
    const onUpdate = (ev) => {
        ...
        formData.append('product_id', id || product.product_id );
        ...
        formData.append('quantity', available_quantity || product.available_quantity);
        formData.append('image', image || null);

        AxiosClient.post(`products/update`, formData, {
            headers: {
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input
                                                                ...
                                                                id="inputName"
                                                                className="form-control m-2"
                                                                placeholder="Product Availabvle Quntity"
                                                                autoFocus
