...
const Products = () => {
    ...
    const { currentUser, products , setCurrentUser, setUserToken, userToken} = useStateContext();
    const [productsList, setProductList] = useState([""]);

    useEffect(() => {
        AxiosClient.get("products").then(res => {
            // console.log(res.data.products, "im here");
    ...
    const deleteProduct = (productId) => {
        ...
        // e.preventDefault();
        AxiosClient.post(`products/delete`,{
            product_id:productId,
             ...
             .then(response => {
                 ...
                 // do something else on successful deletion
             })
             .catch(error => {
                 console.log(error);
                 // handle error
                    ...
                    <div className="content-wrapper">
                        ...
                        <div className="container-xxl flex-grow-1 container-p-y">
                            <div className="row">
                                ...
                                <div className="card pb-5 px-4">
                                    <h5 className="card-header">Products</h5>
                                    <div className="table-responsive text-nowrap">
                                <Link to={'/admin/products/add'} className='btn btn-success d-flex' style={{width:140}}>New Product</Link>
                                            ...
                                            <tbody className="table-border-bottom-0">
                                                {
                                                    productsList.map(product => (
                                                        <tr>
                                                            <td className='avatar avatar-lg pull-up'>
                                                                {/* <pre>{product.image}</pre> */}
                                                                {product.image ? ( <img src={`http://127.0.0.1:8000/storage/products/${product.image}`} alt="Avatar" class="rounded-circle" /> ) : (
                                                                    <img src="http://127.0.0.1:8000/img/default-image.jpg" alt="Avatar" class="rounded-circle" />
                                                                )}
                                                            </td>                                                            
                                                            ...
                                                            <td>
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        <Link class="dropdown-item" to={`/admin/products/update/${product.product_id}`}
                                                                        >
                                                                            <i class="bx bx-edit-alt me-1"></i>
                                                                            Edit
                                                                        </Link>
                                                                        <button class="dropdown-item text-danger" onClick={() =>deleteProduct(product.product_id)}
